...
function Navbar({ user, setUser }) {
  ...
  return (
    <nav
      className="navbar navbar-expand-lg border-bottom sticky-top py-3"
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <button
              onClick={() =>
                window.openAccountDrawer && window.openAccountDrawer()
              }
              title="Account"
              style={{
                position: "relative",
                background: user ? RED : "none",
                border: `2px solid ${user ? RED : "#ccc"}`,
                borderRadius: "50%",
                width: 38,
                height: 38,
                display: "flex",
