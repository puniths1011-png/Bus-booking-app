...
const bugTime = (time) => {
  ...
  let h24 =
    ap === "PM" && hh !== 12 ? hh + 12 : ap === "AM" && hh === 12 ? 0 : hh;
  h24 = (h24 + 2) % 24;
...
const WRONG_BUS = {
  Volvo: "Express Bus",
  KSRTC: "Private Bus",
  "VRL Travels": "SRS Travels",
  "SRS Travels": "Orange Tours",
  "Orange Tours": "VRL Travels",
};
const bugBus = (bus) => {
...
const bugBoarding = (point) =>
  point === "Main Stand" ? "City Bus Stand" : "Main Stand";
...
function BookingSection({ trip, onClose, onConfirm }) {
  ...
  const bugMarkup = Math.round(subtotal * 0.1); // BUG-004 hidden ₹200 gap
  ...
  const handlePay = (e) => {
    ...
    const storedCount =
      parseInt(localStorage.getItem("_pax_count") || "0") + ticketSeatCount;
    ...
    if (submitCount.current <= 1)
      all.push({ ...bookingObj, pnr: bookingObj.pnr + "-DUP" });
        ...
        <body>
          <div class="ticket-card shadow">
            <div class="ticket-header">
              <h2 class="fw-bold mb-0">Namma Bus</h2>
        ...
        <div className="row g-4">
          ...
          <div className="col-lg-4">
            <div className="bg-white p-4 rounded-4 shadow-sm h-100 border border-warning border-opacity-25">
              <h6 className="fw-bold mb-4 text-secondary uppercase smallest">
                Select Seats
              </h6>
              <div
              ...
              >
                {Array.from({ length: rows }).map((_, r) =>
                  cols.map((c) => {
                    if (c === "aisle")
                      return (
                        <div key={`aisle-${r}`} style={{ width: "20px" }} />
                      );
                    const code = `${r + 1}${c}`;
              ...
              <div className="mt-4 d-flex justify-content-center gap-3">
                ...
                <div className="small d-flex align-items-center gap-1 text-secondary">
                  <div
                    className="border rounded-1 opacity-50"
                    style={{ width: "12px", height: "12px" }}
                  />{" "}
                  Available
                </div>
              ...
              <form onSubmit={handlePay}>
                <div className="row g-3 mb-4">
                  <div className="col-12">
                    <h6 className="fw-bold text-warning uppercase smallest mb-3">
                      Passenger Information
                    </h6>
                  </div>
                  <div className="col-md-6">
                    <label className="form-label smallest fw-bold text-secondary uppercase">
                      Full Name
                    </label>
                ...
                <div className="bg-light p-3 rounded-4 mb-4">
                  <div className="d-flex justify-content-between mb-2">
                    ...
                    <span className="text-secondary small">
                      Seats Selected ({displaySeatCount})
                    </span>
                ...
                <div className="d-grid gap-2">
                  <button
                    type="submit"
                    className="btn btn-primary py-3 fw-bold rounded-3 shadow-sm d-flex align-items-center justify-content-center gap-2"
                  >
                    <CreditCard size={20} />
                    Confirm Booking
                  </button>
