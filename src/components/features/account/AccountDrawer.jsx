...
function AccountDrawer({ user, setUser, onOpenAuth }) {
  ...
  const savePersonal = () => {
    ...
    try {
      ...
      if (idx !== -1) {
        users[idx] = updated;
        localStorage.setItem("in_users", JSON.stringify(users));
      }
    } catch (_) {}
    setEditMode(false);
    setSaved(true);
  ...
  const handlePnrAction = () => {
    ...
    try {
      const bookings = JSON.parse(
        localStorage.getItem("in_bus_bookings_v2") || "[]",
      );
      const b = bookings.find(
        (x) => x.pnr.toLowerCase() === pnr.trim().toLowerCase(),
      );
      if (b) {
        setSearchResult(b);
      } else {
      ...
      items: [
        {
          title: "Bookings",
          icon: <Ticket size={19} />,
          action: guard(openBookings),
        },
        {
          title: "Personal Information",
          icon: <User size={19} />,
          action: guard(() => setView("personal")),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          action: guard(() => setView("cancel")),
        },
        {
          title: "Reschedule Ticket",
          icon: <RefreshCw size={19} />,
          action: guard(() => setView("reschedule")),
        },
        {
          title: "Search Ticket",
          icon: <Search size={19} />,
          action: guard(() => setView("searchTicket")),
        },
        {
          title: "Notifications",
          icon: <Bell size={19} />,
          action: guard(() => setView("notifications")),
        },
      ],
    },
  ];
    ...
    <>
      ...
      <div style={drawerStyle}>
        ...
        >
          ...
          <span
            style={{ fontWeight: 700, fontSize: 17, flex: 1, color: "#1a1a1a" }}
          >
            {view === "menu"
              ? "Account"
              : view === "personal"
                  ...
                  <div style={{ textAlign: "center", padding: "10px 0 6px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer",
                        marginBottom: 10,
                        boxShadow: "0 4px 14px rgba(216,78,85,0.25)",
                      }}
                    >
                      Log in
                    </button>
              ...
              {menuSections.map((section, si) => (
                <div key={si} style={{ padding: "12px 0 4px" }}>
                  ...
                  {section.items.map((item, ii) => (
                    ...
                    >
                      <span
                        style={{ color: RED, display: "flex", flexShrink: 0 }}
                      >
                        {item.icon}
                      </span>
                      <span
                  ...
                  {editMode ? (
                    <>
                      <input
                        ...
                        style={{
                          borderColor: formErr.fullname ? RED : "#e5e7eb",
                        }}
                      />
                      {formErr.fullname && (
                  ...
                  {editMode ? (
                    <>
                      <input
                        ...
                        style={{ borderColor: formErr.phone ? RED : "#e5e7eb" }}
                      />
                      {formErr.phone && (
                        <div style={{ fontSize: 12, color: RED, marginTop: 4 }}>
                          {formErr.phone}
                  ...
                  {editMode ? (
                    <>
                      <input
                        ...
                        style={{ borderColor: formErr.email ? RED : "#e5e7eb" }}
                      />
                      {formErr.email && (
                        <div style={{ fontSize: 12, color: RED, marginTop: 4 }}>
                          {formErr.email}
          ...
          {view === "wallet" && (
            <div style={{ padding: 28, textAlign: "center" }}>
              ...
              <p style={{ fontSize: 13, color: "#888" }}>
                Wallet top-up and cashback features coming soon.
              </p>
            </div>
          )}
          ...
          {view === "about" && (
            <div style={{ padding: 24 }}>
              ...
              <p style={{ fontSize: 13, color: "#555", lineHeight: 1.7 }}>
                Namma Bus is your trusted travel partner for hassle-free bus
                ticket booking across India. We connect thousands of routes with
                top operators, offering AC, Non-AC and Sleeper coaches.
              </p>
              <p style={{ fontSize: 13, color: "#555", lineHeight: 1.7 }}>
                Our mission is to make bus travel simple, affordable and
              ...
              {[
                {
                  ...
                  a: "Go to More → Cancel Ticket and enter your PNR.",
                },
                {
                  q: "How do I reschedule?",
                  a: "Go to More → Reschedule Ticket to change your travel date.",
                },
                {
                  q: "How do I get my e-ticket?",
                  a: 'Open My Bookings and click "Get Ticket (PDF)".',
                },
                { q: "Support email", a: "support@Nammabus.in" },
              ].map((item, i) => (
                <div
                  key={i}
                  style={{
            ...
            <div style={{ padding: 24 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    borderColor: actionErr ? RED : "#e5e7eb",
                    paddingRight: 40,
                  }}
                  value={pnr}
              ...
              {actionOk && (
                <div
                  style={{ fontSize: 12, color: "#27ae60", marginBottom: 15 }}
                >
                  {actionOk}
                </div>
              )}
              ...
              {searchResult && (
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 12, color: "#555", marginBottom: 12 }}
                  >
                  ...
                  {view === "searchTicket" && (
                    <div style={{ fontSize: 12, color: "#666" }}>
                      <div style={{ marginBottom: 4 }}>
                        Bus: <strong>{searchResult.bus}</strong>
                      </div>
                      <div>
                        Passenger: <strong>{searchResult.name}</strong>
                      </div>
                    </div>
                  )}
