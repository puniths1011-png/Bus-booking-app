...
function MyBookingsDrawer({ user }) {
      ...
      <html>
        ...
        <body>
          <div class="ticket-card">
            <div class="header">
              <h3 class="mb-0">Namma Bus Ticket</h3>
  ...
  return (
    <div
      ...
      tabIndex="-1"
      id="offcanvasBookings"
      aria-labelledby="offcanvasBookingsLabel"
    >
      ...
      <div className="offcanvas-body bg-light p-3">
        {!user ? (
          <div className="text-center py-5">
            ...
            <p className="text-secondary small fw-semibold">
          ...
          <div className="d-grid gap-3">
            {bookings.map((b) => (
              <div
                key={b.pnr}
                className="card border-0 shadow-sm rounded-4 overflow-hidden animate-fade"
              >
                <div className="card-body p-3">
                  <div className="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <span className="badge bg-success-subtle text-success rounded-pill smallest">
                      PAID
                    </span>
                  </div>
                  ...
                  <div className="row g-2 mb-3 border-bottom pb-2">
                    <div className="col-6">
                      <div className="smallest text-secondary fw-bold uppercase">
                        DATE
                      </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <div>
                      ...
                      <div className="small fw-bold text-warning mono">
                        {b.pnr}
                      </div>
                    </div>
